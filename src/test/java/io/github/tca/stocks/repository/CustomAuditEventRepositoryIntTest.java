...
import io.github.tca.stocks.config.audit.AuditEventConverter;
import io.github.tca.stocks.domain.PersistentAuditEvent;
...
import static io.github.tca.stocks.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
