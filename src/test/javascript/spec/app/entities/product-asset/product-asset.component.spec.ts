...
import { ProductAssetComponent } from 'app/entities/product-asset/product-asset.component';
...
describe('Component Tests', () => {
    describe('ProductAsset Management Component', () => {
        let comp: ProductAssetComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProductAssetComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.productAssets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
