...
import { StockOrderComponent } from 'app/entities/stock-order/stock-order.component';
...
describe('Component Tests', () => {
    describe('StockOrder Management Component', () => {
        let comp: StockOrderComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StockOrderComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.stockOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
